...
?>
<h2><font face='Cascadia Code' color='white'>Login Form</font></h2>
<form method="post">
	...
	<div class="row">
		<div class="col-sm-4"><font color='white'>Enter User ID</font></div>
		<div class="col-sm-5">
		<input type="email" name="e" class="form-control"/></div>
	</div>
	
	<div class="row">
		<div class="col-sm-4"><font color='white'>Enter Password</font></div>
		<div class="col-sm-5">
